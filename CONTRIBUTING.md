...
Check that [our issue database](https://github.com/drabkirn/web/issues)
...
2. Install the app on your local machine. You need to [Fork](https://help.github.com/articles/fork-a-repo/) this app and then clone it on your local machine. See the Installation section of [README.md](https://github.com/drabkirn/web/blob/master/README.md) on how to do the installation.
...
3. Set the upstream remote so you can keep your copy of the app synced with the original. To do that, go to your terminal and cd into your cloned Drabkirn Rails Base app directory. Then use one of the following commands:
    * If you have ssh set up with Git
      ```bash
      $ git remote add upstream https://github.com/drabkirn/web.git
      ```
      Or
      ```bash
      git remote add upstream git@github.com:drabkirn/web.git
      ```
