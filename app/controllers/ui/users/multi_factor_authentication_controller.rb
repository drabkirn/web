class Ui::Users::MultiFactorAuthenticationController < ApplicationController
  before_action :authenticate_user!
  before_action :set_user
  before_action :require_non_omniauth_user
  ...
  private
    ...
    def require_non_omniauth_user
      if current_user.provider?
        redirect_to edit_user_registration_path, alert: Message.two_fa_for_non_omniauth_user(current_user.provider)
      end
    end
end